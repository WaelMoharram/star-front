            ...
            <div class="container clearfix">
                ...
                <div class="row align-items-stretch gutter-20 min-vh-60">
                    <div class="col-md-8">
                        ...
                        <div class="row align-items-stretch gutter-20 h-100">
                            <div class="col-md-6 min-vh-25 min-vh-md-0">
                                <a href="shop.php" class="grid-inner d-block h-100" style="background-image: url('images/star/electric.jpeg');"></a>
                            </div>

                            <div class="col-md-6 min-vh-25 min-vh-md-0">
                                <a href="shop.php" class="grid-inner d-block h-100" style="background-image: url('images/star/fans.jpeg'); background-position: right center;"></a>
                            </div>

                            <div class="col-md-12 min-vh-25 min-vh-md-0 pb-md-0">
                                <a href="shop.php" class="grid-inner d-block h-100" style="background-image: url('images/star/electrics.jpeg');"></a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 min-vh-50">
                        <a href="shop.php" class="grid-inner d-block h-100" style="background-image: url('images/star/lamps.jpeg'); background-position: center top;"></a>
                    </div>
                </div>
...
<!--                    <div class="tab-container">-->
                        ...
                        <div class="tab-content" id="tabs-9">
                            ...
                            <div class="shop row gutter-30">
                                ...
                                <?php
                                for ($i=1;$i<5;$i++){
                                    include('card-index.product.html');
                                }
                                ?>
